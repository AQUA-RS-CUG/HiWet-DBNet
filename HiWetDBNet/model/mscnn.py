...
class MSCNN(nn.Module):
    ...
    def forward(self, optical_data, sar_data):
        ...
        s_output2, s_connect2, s_output3, s_connect3 = self.sar_model(sar_data)
        ...
        return output_level2, output_level3, s_output2, s_output3
...
if __name__ == "__main__":
    ...
    optical_input = Variable(torch.randn(64, 12, 15, 15))
